...
export function SessionPanel() {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "fixed right-0 top-0 h-full w-[400px] bg-white shadow-2xl z-50 transition-transform duration-300 ease-in-out flex flex-col rounded-tl-2xl overflow-hidden",
